...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002642371814').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
auth_channel = environ.get('AUTH_CHANNEL', '-1004756136680')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1004756136680'))
request_channel = environ.get('REQUEST_CHANNEL', '-1004756136680') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1004756136680')) # 
