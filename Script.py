import os
class script(object):
    START_TXT = """ʜᴇʏ {}, {}\n\n🍿 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝗭𝗮𝗿𝗮𝗳𝗹𝗶𝘅 — 𝘆𝗼𝘂𝗿 𝗽𝗲𝗿𝘀𝗼𝗻𝗮𝗹 𝗺𝗼𝘃𝗶𝗲 & 𝘄𝗲𝗯 𝘀𝗲𝗿𝗶𝗲𝘀 𝗵𝗲𝗹𝗽𝗲𝗿.\n\n🎬 𝗝𝘂𝘀𝘁 𝘁𝘆𝗽𝗲 𝘁𝗵𝗲 𝗻𝗮𝗺𝗲 𝗼𝗳 𝘁𝗵𝗲 𝗺𝗼𝘃𝗶𝗲 𝗼𝗿 𝘄𝗲𝗯 𝘀𝗲𝗿𝗶𝗲𝘀 𝘄𝗶𝘁𝗵 𝗰𝗼𝗿𝗿𝗲𝗰𝘁 𝘀𝗽𝗲𝗹𝗹𝗶𝗻𝗴, 𝗮𝗻𝗱 𝗜’𝗹𝗹 𝗳𝗶𝗻𝗱 𝗶𝘁 𝗳𝗼𝗿 𝘆𝗼𝘂 𝗶𝗻𝘀𝘁𝗮𝗻𝘁𝗹𝘆! ⚡"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/ZaraflixBot'>ℤ𝕒𝕣𝕒𝕗𝕝𝕚𝕩</a></b></blockquote>"""
    

    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : ℤ𝕒𝕣𝕒𝕗𝕝𝕚𝕩\n‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/ZaraflixBot'>ℤ𝕒𝕣𝕒𝕗𝕝𝕚𝕩</a>\n‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ\n‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ\n‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\n‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ᴀʟʟ ᴡᴇʙ\n‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ5.2 [sᴛᴀʙʟᴇ]</b></blockquote>"""    
...
🆔 ᴜᴘɪ ɪᴅ ➩ <code>@ZaraflixAdmin_Bot/code> [ᴄᴏɴᴛᴀᴄᴛ ᴀᴅᴍɪɴ]
...
--------------Set Ads----------------
➩ /set_ads {ads name}}#{Times}#{photo URL} - <a href="https://t.me/ZaraflixBot/11">Explain</a>
➩ /del_ads - Delete ads
-------------Top Trending------------
➩ /setlist {Mirzapur, Money Heist} - <a href=https://t.me/ZaraflixBot/10>Explain</a>
...
--------------Verify On Off------------
/verifyoff {{verify.off code}} - off verification <a href="https://t.me/ZaraflixBot">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ ᴄᴏᴅᴇ
/verifyon - on verification 
------------Set File Caption-----------
/set_caption - set coustom file caption 
-----------Set Imdb Template-----------
/set_template - set IMDb template <a href="https://t.me/ZaraflixBot/8">Example</a>
--------------Set Tutorial-------------
...
Iғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴅᴏᴜʙᴛs ᴘʟᴇᴀsᴇ <a href="https://t.me/ZaraflixBot">ᴄᴏɴᴛᴀᴄᴛ</a> ᴍʏ <a href="https://t.me/ZaraflixBot">ᴀᴅᴍɪɴ</a></b>"""
